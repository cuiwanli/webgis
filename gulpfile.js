...
gulp.task('watch', function() {
    ...
    // Watch .jade files
    gulp.watch('public/jade/*.jade', renderJade);

    // Watch .sass files
    gulp.watch('public/stylesheets/*.sass', renderSass);

    // Watch .js files
    gulp.watch('public/javascripts/*.js', renderJS);

    // Watch image files
    gulp.watch('public/images/*', renderIMG);
